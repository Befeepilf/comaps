...
UNIT_TEST(GenerateShortShowMapUrl_ZoomLarge)
{
  ...
  TEST_EQUAL("streifzug://_wAAAAAAAA/Name", res, ());
}
...
UNIT_TEST(GenerateShortShowMapUrl_FractionalZoom)
{
  ...
  TEST_EQUAL("streifzug://RwAAAAAAAA/Name", res, ());
}
...
UNIT_TEST(GenerateShortShowMapUrl_UnicodeMixedWithOtherChars)
{
  ...
  TEST_EQUAL("streifzug://8wAAAAAAAA/Back%20in_\xe2\x98\x84%21\xd1\x8e\xd0\xbc", res, ());
}

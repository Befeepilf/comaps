...
| OQ-15 | Phase 7 M7 competition stub (draft SPD-052). Competition line on the card? Proposal: card works with no profile/nickname; stub for §22.10; Phase 8 fills. Not a decision. | SP-062 (2026-08-19); spec §19.2, §22.10 | Phase 7 (SP-065); Phase 8 fills copy. |

...
| GPX tests | `libs/kml/kml_tests/gpx_tests.cpp` (binary **`kml_tests`**) | Substantial coverage: malformed, skip, entity, 10k/50k parse. Roundtrip goldens use `creator="CoMaps"`. |

...
| Phase 4 | R1 (narrowed): production mapgen collectors → `.spa` / CDN shipping | Pre-production packaging — [SP-042](../work-items/SP-042-sidecar-shipping-decisions.md) / **SPD-033**; follow-ons SP-043–048. **Not** a Phase 10 device item |

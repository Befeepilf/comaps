...
- Append **SPD** entries covering at least the locks in the table below.
  ...
  Accepted policy (SP-062 pattern).
...
- Do not mark this work item or Phase 9 exit Accepted unilaterally.
...
maintainer lock**. Last Accepted SPD remains **SPD-066**. These drafts are
**not** numbered sections in `DECISIONS.md` until Accepted.

### Draft SPD-067 (G1 / OQ-20)
...
1. G1–G10 are recorded as Accepted SPDs **or** remain explicit proposed
   OQs awaiting lock. Coding SP-081+ does not start until G1, G5, G6, and
   G7 are Accepted (those four block binary work).
...
- Maintainer review of G1–G10 / draft SPD-067–076.
...
| --- | --- |
| Branch | `cursor/phase-09-work-items-db9d` |
| Product-owner lock | Not yet |
| Decision ids | Draft SPD-067–076 / OQ-20–OQ-29 |
| Accepted by | — |
| Accepted date | — |

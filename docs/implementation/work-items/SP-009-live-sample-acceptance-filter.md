...
**Status:** Not started
**Branch:** `street-pixels/SP-009-live-sample-acceptance-filter`
...
| Branch | |
| Commits | |
| Staleness rule chosen and rationale | |
| Teleport rule chosen and rationale | |
| Constants and values | |
| Test output | |
| Open-area walk: accepted / rejected counts | |
| Urban-canyon walk: accepted / rejected counts | |
| Cycling route: accepted / rejected counts | |
| Vehicle-passenger result | |
| Tunnel result | |
| Screen-off batched-sample result | |

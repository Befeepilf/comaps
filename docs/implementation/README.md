...
| 64 | [SP-064](work-items/SP-064-first-100-metres-goal.md) | First-100-metres contextual goal | 7 | **In review** — 10 newly explored live pixels |
...
SP-064 **In review**. SP-065–069 **Planned**. Phase 7 **In progress**; stylised-map entry criterion

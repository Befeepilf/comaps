...
| Order | ID | Title | Phase | Why first |
| --- | --- | --- | --- | --- |
| 23 | [SP-023](work-items/SP-023-admin-polygon-size-spike.md) | Spike: admin polygon retention size and coverage | 4 | Planned — unblocks store/assignment decisions |
...
| 25 | [SP-025](work-items/SP-025-country-config-schema.md) | Versioned country-config schema | 4 | Planned — data contract |
| 26 | [SP-026](work-items/SP-026-generator-true-polygons.md) | Generator: emit true closed exploration polygons | 4 | Planned — depends on SP-024 |
| 27 | [SP-027](work-items/SP-027-client-polygon-runtime-api.md) | Client runtime polygon API | 4 | Planned — offline PIP |
| 28 | [SP-028](work-items/SP-028-pixel-to-area-assignment.md) | Deterministic pixel-to-area assignment | 4 | Planned — §8.8 rules |
| 29 | [SP-029](work-items/SP-029-settlement-fallback-and-no-area.md) | Settlement fallback and no-area state | 4 | Planned — SPD-007 |
| 30 | [SP-030](work-items/SP-030-assignment-persistence-and-rematch.md) | Persist assignments and rematch hooks | 4 | Planned — durable area ids |

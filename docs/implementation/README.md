...
| 4 | Administrative-area pipeline | [`phases/phase-04-administrative-area-pipeline.md`](phases/phase-04-administrative-area-pipeline.md) | In progress (SP-026 In review) |
...
| SP-026 | In review — `.spa` format + library + fixture tests |
| SP-027–031 | Planned — client API, assignment, validation |
...
| 26 | [SP-026](work-items/SP-026-generator-true-polygons.md) | Generator: emit true closed exploration polygons | 4 | **In review** — per-MWM `.spa` + `street_pixels_areas` |

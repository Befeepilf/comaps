...
| 11 | Independent map build and serve | [`phases/phase-11-independent-map-build-and-serve.md`](phases/phase-11-independent-map-build-and-serve.md) | In progress (SP-098 **Accepted** 2026-08-29 — **SPD-087–096**; SP-099–101 **In review**; exit **not met**) |
...
| SP-098–104 | SP-098 **Accepted** 2026-08-29 (**SPD-087–096**; P9 extras **on**); SP-099–101 **In review**; SP-102–104 **Planned** |
...
P9 override extras **on**). SP-099, SP-100, and SP-101 **In review**. Coding
SP-102+ may proceed in parallel with Phases 5–10. It does not change the Phase 5

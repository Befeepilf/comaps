...
| 65 | [SP-065](work-items/SP-065-area-milestone-presentation.md) | Area milestone presentation (25 / 50 / 100) | 7 | In review — non-blocking, non-interrupting |
...
SP-064 **Accepted** (2026-08-19). SP-065 **In review**. SP-066–069 **Planned**. Phase 7 **In progress**; stylised-map entry criterion

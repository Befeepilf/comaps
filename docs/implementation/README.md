...
| 66 | [SP-066](work-items/SP-066-exploration-haptics-policy.md) | Exploration haptics policy | 7 | **In review** — recording ∧ foreground ∧ toggle; one collection pulse; 50/100/first-goal patterns |
...
SP-064 **Accepted** (2026-08-19). SP-065 **Accepted** (2026-08-20). SP-066 **In review**. SP-067–069 **Planned**. Phase 7 **In progress**; stylised-map entry criterion

...
| 4 | Administrative-area pipeline | [`phases/phase-04-administrative-area-pipeline.md`](phases/phase-04-administrative-area-pipeline.md) | In progress (SP-024 Accepted; SP-025 In review) |
...
| SP-025–031 | SP-025 In review; SP-026–031 Planned — generator, assignment, validation |
...
| 25 | [SP-025](work-items/SP-025-country-config-schema.md) | Versioned country-config schema | 4 | In review — `data/street_pixels/` JSON + `street_pixels_config` loader (SPD-023) |

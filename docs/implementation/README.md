...
**Next: SP-036 focus-selection engine (§12.5).** SP-033 quantitative Spike 1
remains a Phase 10 residual. Phase 5 entry investigation:
...
SPD-026 locks personal completion. Next: SP-036 focus-selection engine.

...
| 4 | Administrative-area pipeline | [`phases/phase-04-administrative-area-pipeline.md`](phases/phase-04-administrative-area-pipeline.md) | In progress (SP-027 Accepted; SP-028 In review) |
...
| SP-028 | In review — consume/verify precomputed subdivision map (SPD-021) |
| SP-029–031 | Planned — settlement, rematch, validation |
...
| 28 | [SP-028](work-items/SP-028-pixel-to-area-assignment.md) | Deterministic pixel-to-area assignment | 4 | **In review** — consume/verify precomputed subdivision map (SPD-021) |

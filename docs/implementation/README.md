...
| 8 | Competition | [`phases/phase-08-competition.md`](phases/phase-08-competition.md) | SP-070 Accepted; SP-071 in progress; SP-072 Accepted |
...
(2026-08-25). Backend items SP-075–077 land in `comaps_backend`. Detailed work

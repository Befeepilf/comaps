...
| 57 | [SP-057](work-items/SP-057-avoid-explored-engine.md) | Avoid-explored engine (strict pass + distinct no-route) | 6 | **In progress** — exclude `exploredRatio == 1` (SPD-042) |
...
OQ-2 closed). SP-056 **Accepted** 2026-08-15. SP-057 **In progress**.

...
For the subway layer to be available in Streifzug, a `SUBWAY_URL`
...
Normally you can specify this link https://cdn.streifzug.app/subway.json,
...
1.  With the [Streifzug subways](https://codeberg.org/comaps/subways) repository deployed,
